...
if time_of_exam - 60 < time_of_arriving < time_of_exam:
    ...
    # {minutes:02d} for adding a 0 before a number 0,1,2,6,...,9:
    # if minutes < 10: # checks numbers 0,1,2,6,...,9 to add a zero in front of them
    # print(f"{hours}:O{minutes} hours before the start")
    # else:
